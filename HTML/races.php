...
<body>
    ...
    <div class="kontajner">
        ...
        <div class="page_content">
            ...
            <div class="obal_textu obal_obrazku"><img class="races_obrazky" src="../IMGS/imperium_of_man.jpg" alt="imperium_of_man" title="imperium_of_man"></div>
            ...
            <div class="obal_textu obal_obrazku"><img class="races_obrazky" src="../IMGS/races_orcs.jpg" alt="races_orcs" title="races_orcs"></div>
            ...
            <div class="obal_textu">
                ...
                <p>
                    ...
                    Linguistically reflecting their diminished status, the Asuryani made themselves known to outsiders as "Eldar," a name which came to be applied to the entire species by Imperial savants for many millennia.
                    ...
                    In recent years, since the formation of the Ynnari faction which contains members of the Aeldari species from all of the other factions, it has become common for many of the Asuryani to once more refer to themselves using the ancient term "Aeldari."
                </p>
            </div>
            <div class="obal_textu obal_obrazku"><img class="races_obrazky" src="../IMGS/the_aeldari.jpg" alt="the_aeldari" title="the_aeldari"></div>
            ...
            <div class="obal_rasy">
                ...
                <div class="obal_textu obal_obrazku"><img class="races_obrazky" src="../IMGS/drukhari.png" alt="drukhari" title="drukhari"></div>
            ...
            <div class="obal_textu obal_obrazku"><img class="races_obrazky" src="../IMGS/the_tyranids.jpg" alt="the_tyranids" title="the_tyranids"></div>
            ...
            <div class="obal_textu">
                ...
                <p>
                    The birth of the entities later known as the C'tan or the Star Gods occurred at the same time as the moment of Creation itself, as they formed from the vast, insensate energies first unleashed by that churning mass of cataclysmic force.
                    In that anarchic interweaving of matter and energy, the sea of stars began to swirl into existence and for an eon the universe was nothing more than hot hydrogen gas and light elemental dust ruled over by the gravitic force of billions of newborn suns.
                    Long before the first planets had formed and cooled, the very first truly self-aware beings emerged, their thoughts encased within the lines of force produced by the plasma and electromagnetic flares of the stars themselves.
                    ...
                    They were little more than monstrous energy parasites that suckled upon the solar energies of the stars that had brought them into existence, shortening the lives of otherwise main-sequence stars by millions of standard years.
            ...
            <div class="obal_textu obal_obrazku"><img class="races_obrazky" src="../IMGS/the_necrons.jpg" alt="the_necrons" title="the_necrons"></div>
            ...
            <div class="obal_textu obal_obrazku"><img class="races_obrazky" src="../IMGS/races_chaos.jpg" alt="races_chaos" title="races_chaos"></div>
